ItemPrices:
	...
	money 5000  ; DOME_FOSSIL
	money 5000  ; HELIX_FOSSIL
	money 0     ; SECRET_KEY
	money 0     ; XXX
	...
	money 600   ; FULL_HEAL
	money 500   ; REVIVE
	money 1000  ; MAX_REVIVE
	money 700   ; GUARD_SPEC
	money 400   ; SUPER_REPEL
	money 500   ; MAX_REPEL
	money 650   ; DIRE_HIT
	money 10    ; COIN
	...
	money 0     ; OAKS_PARCEL
	money 0     ; ITEMFINDER
	money 99999 ; SILPH_SCOPE
	money 4500  ; POKE_FLUTE
	money 0     ; LIFT_KEY
	money 5000  ; EXP_ALL
	money 0     ; OLD_ROD
	money 0     ; GOOD_ROD
	money 1500  ; SUPER_ROD
	money 800   ; PP_UP
	money 0     ; ETHER
	money 900   ; MAX_ETHER
	money 0     ; ELIXER
	money 900   ; MAX_ELIXER
	money 0     ; FLOOR_B2F
	money 0     ; FLOOR_B1F
	money 0     ; FLOOR_1F
	money 0     ; FLOOR_2F
